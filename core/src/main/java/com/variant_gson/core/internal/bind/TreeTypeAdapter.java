...
import com.variant_gson.core.JsonDeserializationContext;
import com.variant_gson.core.JsonDeserializer;
import com.variant_gson.core.JsonElement;
import com.variant_gson.core.JsonParseException;
import com.variant_gson.core.JsonSerializationContext;
import com.variant_gson.core.JsonSerializer;
...
public final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    static TreeTypeAdapter<?> create(@Nullable JsonSerializer<?> serializer, @Nullable JsonDeserializer<?> deserializer,
                                     Gson gson, TypeToken<?> typeToken, @Nullable TypeAdapterFactory skipPast) {
        return new TreeTypeAdapter(serializer, deserializer, gson, typeToken, skipPast);
    }
}
