package com.variant_gson.core.internal.bind.util
...
object ISO8601Utils {
    ...
    fun parse(date: String?, pos: ParsePosition): Date {
        val fail: Exception?
        try {
                ...
                if ("+0000" == timezoneOffset || "+00:00" == timezoneOffset) {
                    ...
                    if (act != timezoneId) {
                        ...
                        if (cleaned != timezoneId) {
                            throw IndexOutOfBoundsException("Mismatching time zone indicator: " + timezoneId + " given, resolves to "
                                    + timezone.id)
                        }
                    }
                }
